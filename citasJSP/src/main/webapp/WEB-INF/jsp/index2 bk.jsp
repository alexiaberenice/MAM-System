...
<body>
				...
				<div class="col-md-12">
					<div class="content">
						...
						<table id="id_table" class="table table-striped table-bordered">
							...
							<c:forEach items="${citasList}" var="cita">
								<tr>
									<td>${cita.id}</td>
									<td>${cita.fecha}</td>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_nombre"
														name="nombre" type="datetime-local" />
												</div>
											</div>
	...
	<script type="text/javascript">
		$.getJSON("listaDoctor", {}, function(data) {
					...
					.DataTable(
							{
								...
								columns : [
										...
										},
										{
											data : function(row, type, val,
													meta) {
												var salida = '<button type="button" style="width: 90px" class="btn btn-warning btn-sm" onclick="eliminar(\''
														+ row.id
														+ '\')">Eliminar</button>';
												return salida;
											},
